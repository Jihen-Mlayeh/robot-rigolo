...
class GameListPageFacile extends StatefulWidget {
  const GameListPageFacile({Key? key}) : super(key: key);

  @override
  _GameListPageFacileState createState() => _GameListPageFacileState();
}

class _GameListPageFacileState extends State<GameListPageFacile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        // On enveloppe le contenu dans un Stack afin d'ajouter l'overlay des objets volants.
        child: Stack(
          children: [
            Column(
              children: [
                ...
                // Le GameContainer occupe le reste de l'espace
                Expanded(
                  child: GameContainer(
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ExerciceTemplate(
                          ...
                          timerEnabled: timerEnabled,
                          exerciceFile: 'assets/questions/simple_calcul_facile.json',
                        ),
                      ),
                    );
                  },
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => BullesMagiquesPage(
                            file: "assets/questions/simple_calcul_facile.json",
                          )
                      ),
                    );
                  },
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ExerciceTemplate(
                          ...
                          timerEnabled: timerEnabled,
                          exerciceFile: 'assets/questions/complete_suite_facile.json',
                        ),
                      ),
                    );
                  },
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ExerciceTemplate(
                          ...
                          timerEnabled: timerEnabled,
                          exerciceFile: 'assets/questions/trouve_intrus_facile.json',
                        ),
                      ),
                    );
                  },
...
class _FlyingItemsOverlayState extends State<FlyingItemsOverlay> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children:
      List.generate(itemCount, (index) => FlyingItem(key: UniqueKey())),
    );
  }
}
...
class _FlyingItemState extends State<FlyingItem>
  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      ...
      // Positions aléatoires de départ et d'arrivée
      ...
      _controller = AnimationController(
        vsync: this,
        duration: Duration(seconds: 5 + random.nextInt(3)), // 5 à 7 secondes
      );
      ...
      builder: (context, child) {
        return Positioned(
          ...
          child: GestureDetector(
            onTap: _onTap,
            child: exploded
                ? Image.asset('assets/images/other/celebration.png',
                width: 80, height: 80)
                : Image.asset('assets/images/other/fly22.png',
                width: 80, height: 80),
          ),
        );
      },
